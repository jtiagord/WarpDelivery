...
interface ApiInterface {
    ...
    @GET("warpers/{username}/vehicles")
    fun getWarperVehicles(@Path("username") username: String) : Call<List<Vehicle>>
    ...
    fun tryAddVehicle(@Path ("username") username: String, @Body vehicle: Vehicle): Call<Unit>
